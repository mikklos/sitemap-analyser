    ...
    function runWithXmlText(t) {
        ...
        function renderDepthBubbles() {
            ...
            var scale = function(value) {
                return minRadius + (maxRadius - minRadius) * (value / maxCount);
            };
