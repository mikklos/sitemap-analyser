    ...
    function runWithXmlText(t) {
        ...
        function renderDepthBubbles() {
            ...
            for (var i = 0; i < depthKeys.length; i++) {
                ...
                var colorClass;
                if (depth <= 3) {
                    colorClass = 'g'; // Green (Låg Risk)
                } else if (depth <= 6) {
                    colorClass = 'o'; // Orange (Viss Risk)
                } else {
                    colorClass = 'r'; // Red (Hög Risk)
                }
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                text.setAttribute('data-depth', d.depth);
            ...
            // Add click listener to bubbles/text for filtering
            svg.querySelectorAll('.bubble, text[data-depth]').forEach(function(el) {
