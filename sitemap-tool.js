(function() {
    ...
    if (!syntheticEl && !/\.xml(\?|#|$)/i.test(location.href)) {
        E('Denna bookmarklet fungerar endast på en fil med ändelsen .xml eller ett fönster med genererad sitemap.');
        return
    }
